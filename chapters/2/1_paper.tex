...
\begin{equation}
    \tau_{\mathrm{react}} = \frac{1}{\rho N_A \langle \sigma v \rangle Y_j}
\end{equation}
...
Earlier in the evolution of this stellar model, it produces the \pnucn{} by the \gprn{} in the first convective \oxygen[]-shell which extends from $1.55\Msun$ to $1.95\Msun$ during model numbers $6200${--}$7200$.
...
The downturn can be seen both at the bottom of a shell \cite{herwigHydrodynamicSimulationsHe2006, meakinTurbulentConvectionStellar2007} or at the top \cite{jonesIdealizedHydrodynamicSimulations2017}.
...
\cite{andrassy3DHydrodynamicSimulations2020} in their 3D C-shell entrainment simulations that their r.m.s. velocities could be up to $\sim 5$ times stronger than \cite{jonesIdealizedHydrodynamicSimulations2017} depending on the luminosity from carbon and oxygen burning.
...
\hline
Scenario & No Ingest. & $\natlog{4}{-5}$ & $\natlog{4}{-4}$ & $\natlog{4}{-3}$ & MC Spread \\
         &            & $(\Msun\second^{-1})$ & $(\Msun\second^{-1})$ & $(\Msun\second^{-1})$ &  \\
\hline
...
Locations of peak destruction can be identified by a sudden drop in mass fraction as seen for \dysprosium[156], \mercury[196], and to a lesser extent \samarium[144].
...
We find that it is possible that the ratio can tend to uniity as mixing speeds increase as seen for \ruthenium[96,98], \cadmium[106,108], and \tin[112, 114].
...
The difference in \OP between two ingestion rates is largely uniformly for \molybdenum[92]{-}\mercury[196].
